                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">CDS Table</strong>
                            </div>
                            <div class="card-body">
							<?php
$se=" select * from `reg`,`login` where reg.logid=login.logid and login.usertype='4'";
...
<td>
<a href="delete.php?id=<?php echo $row["userid"]; ?>" ><button>Delete</button></a>
</td>
</tr>
<?php
}
