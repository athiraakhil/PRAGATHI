        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<li class="menu-title">Job Details</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Job Details</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="adminviewjobs.php">Approval Pending </a></li>
							<li><i class="fa fa-table"></i><a href="viewapprovedjobs.php">Approved Jobs </a></li>
							<li><i class="fa fa-table"></i><a href="viewrejectedjobs.php">Rejected Jobs </a></li>
                            <!--<li><i class="fa fa-table"></i><a href="tables-data.html">view Salary Details</a></li>-->
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="adminviewproducts.php">Product Details</a></li>
							<li><i class="fa fa-table"></i><a href="adminviewcheckout.php">Checkout Details</a></li>
							<li><i class="fa fa-table"></i><a href="adminviewpayment.php">Payment Details</a></li>
                            <!--<li><i class="fa fa-table"></i><a href="tables-data.html">view Salary Details</a></li>-->
                        </ul>
                    </li>
                    <!--<li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <!--<li><a href="#"></a></li>
                                    <li><a href="#"></a></li>
                                    <li class="active">Exhibition table</li>-->
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Approval Pending</strong>
                            </div>
                            <div class="card-body">
							<?php
$se=" select * from job join function join district on job.funtid=function.funtid and job.district=district.distid where status=0";
...
<td style="font-size: 15px;"> 
  ...
  <td>
<a href="jobapprove.php?id=<?php echo $row["jobid"]; ?>" ><button>Approve</button></a>
</td>
</tr>
<?php
}
