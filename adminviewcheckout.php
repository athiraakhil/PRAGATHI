                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Checkout Details</strong>
                            </div>
                            <div class="card-body">
							<?php
$se=" select * from `checkout` join district on checkout.cdistrict=district.distid";
...
<td style="font-size: 15px;"> 
  ...
  <td>
<a href="checkoutdelete.php?id=<?php echo $row["checkid"]; ?>" ><button>Delete</button></a>
</td>
</tr>
<?php
}
