...
return true;
				...
				<div class="form-row">
					...
					<input type="text" name="cnumber" id="cno" OnChange="return validateform7()" class="input-text" placeholder="" autocomplete="off" required>
...
return true;
				...
				<div class="form-row">
					...
					<input type="password" name="password" id="pass" OnChange="return validateform8()" class="input-text" placeholder="" autocomplete="off" required>
					<!--<i class="fas fa-lock"></i>-->
					<script>
...
$sq="insert into login(username,password,usertype,status)values('$g','$i',1,0)";
...
$sql="insert into addmember(logid,name,address,dob,ano,gid,wardid,cno)values('$lid','$a','$b','$c','$d','$e','$f','$g')";
 $ch=mysqli_query($con,$sql);
if($ch)
{?>
 <script>
 alert("Successfully added");
 window.location='adsaddmember.php'</script>
	<?php
}
else
{
