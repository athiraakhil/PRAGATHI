            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <!--<li><i class="fa fa-table"></i><a href="tables-basic.html">Add Job Vacancies </a></li>-->
                            <li><i class="fa fa-table"></i><a href="adminunits.php">view Details</a></li>
                        </ul>
                    </li>
					<li class="menu-item-has-children dropdown">
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="POST">
					<h3><center><font color=black>UNITS</center></h3>
					<br>
					<?php
...
?>
                         <form action="adminviewunits.php" method="POST">
						 <input type="hidden" name="id" value="<?php echo $row['gid']; ?>"/>
                        <input type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" name="submit"  value="<?php echo $row['gname'];?>">
						<br>
						</form>
						<?php
